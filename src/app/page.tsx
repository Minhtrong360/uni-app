...
import { Progress } from "@/components/ui/progress"
import { Button } from "@/components/ui/button"
import { HeartHandshake, CalendarDays, ShoppingBag, Rocket, Bell, Book, Utensils, Dumbbell, Bus, Laptop, Users, HelpCircle } from "lucide-react"
import { useRouter } from "next/navigation"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-3 space-y-6">
          <section className="bg-secondary p-6 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">65% of services utilized this semester</p>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-secondary p-6 rounded-lg">
                ...
                <h3 className="text-xl font-semibold mb-2">Student Support Center</h3>
              ...
              <div className="bg-secondary p-6 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">3 upcoming this week</p>
              </div>
              </Link>
              <Link href="/store">
              <div className="bg-secondary p-6 rounded-lg">
              ...
              <div className="bg-secondary p-6 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">Submissions due in 2 weeks</p>
              </div>
              </Link>
              ...
              <div className="bg-secondary p-6 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">View today is menu</p>
              </div>
              <div className="bg-secondary p-6 rounded-lg">
              ...
              <div className="bg-secondary p-6 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">Check routes and schedules</p>
              </div>
              <div className="bg-secondary p-6 rounded-lg">
                <Laptop className="w-10 h-10 mb-4" />
                <h3 className="text-xl font-semibold mb-2">IT Help Desk</h3>
                <p className="text-sm text-muted-foreground">Get tech support</p>
              </div>
            </div>
          </section>
        </div>
          ...
          <section className="bg-secondary p-6 rounded-lg">
            ...
            <nav className="space-y-2">
              <Button variant="ghost" className="w-full justify-start">
                <CalendarDays className="mr-2 h-4 w-4" /> Academic Calendar
              </Button>
              <Button variant="ghost" className="w-full justify-start">
              ...
              <Button onClick={() => router.push(`/support/faqs`)} variant="ghost" className="w-full justify-start">
