    ...
    return (
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>Your detailed feedback has been successfully submitted and will help us improve future events.</CardDescription>
        </CardHeader>
      </Card>
    )
  }
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>We value your detailed feedback to enhance our future events.</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select required>
              ...
              <SelectContent>
                ...
                <SelectItem value="conference">Annual Student Conference</SelectItem>
                  ...
                  {[1, 2, 3, 4, 5].map((star) => (
                    <StarIcon
                      ...
                      className={`w-6 h-6 cursor-pointer ${
                        star <= (ratings[aspect.id] || 0) ? "text-yellow-400 fill-yellow-400" : "text-gray-300"
                      }`}
          ...
          <div className="space-y-2">
            ...
            <Textarea id="highlights" placeholder="What aspects of the event did you find most valuable?" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="improvements">Suggested Improvements</Label>
            <Textarea id="improvements" placeholder="How could we enhance this event in the future?" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="topics">Future Topics of Interest</Label>
            <Textarea id="topics" placeholder="What topics would you like to see covered in future events?" />
          </div>
          <div className="space-y-2">
            ...
            <Select required>
              ...
              <SelectContent>
                ...
                <SelectItem value="not-recommend">Would Not Recommend</SelectItem>
              </SelectContent>
            </Select>
          </div>
