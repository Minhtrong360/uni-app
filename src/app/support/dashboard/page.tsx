...
export default function SchoolSupportDashboard() {
  ...
  const supportRequests = [
    ...
    { id: 3, student: "Charlie Brown", issue: "Missed soccer practice", category: "Extracurricular", status: "Closed", priority: "Low", date: "2023-06-03", description: "Charlie has missed several soccer practices and needs to discuss team commitment." },
    { id: 4, student: "Diana Prince", issue: "Struggling with essay writing", category: "Academic", status: "Open", priority: "High", date: "2023-06-04", description: "Diana is having difficulty structuring her essays for English class and requires writing support." },
    { id: 5, student: "Ethan Hunt", issue: "Anxiety about upcoming exams", category: "Wellbeing", status: "In Progress", priority: "Medium", date: "2023-06-05", description: "Ethan is experiencing high levels of anxiety due to upcoming final exams." },
  ]
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          <Card className="bg-white dark:bg-gray-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Academic Support</CardTitle>
          ...
          <Card className="bg-white dark:bg-gray-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Social Support</CardTitle>
          ...
          <Card className="bg-white dark:bg-gray-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Student Wellbeing</CardTitle>
          ...
          <CardContent>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 mb-6">
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-2 w-full md:w-auto">
                <Input className="max-w-sm" placeholder="Search support requests..." />
                    ...
                    {supportRequests.map((request) => (
                      <TableRow key={request.id}>
                        ...
                        <TableCell className="text-right">
                          <Button onClick={() => router.push(`/support/details`)} variant="outline" size="sm">
                            View
                          </Button>
                        </TableCell>
                      </TableRow>
                  ...
                  <Card key={request.id} className="bg-white dark:bg-gray-800 overflow-hidden">
                    <div className="relative h-48 w-full">
                      ...
                      <div className="absolute bottom-4 left-4 right-4">
                        <h3 className="text-lg font-semibold text-white">{request.student}</h3>
