                  ...
                  <Tabs defaultValue="overview">
                    ...
                    <TabsContent value="overview">
                      <Card>
                        ...
                        <CardContent>
                          <p>
                            The Student Support Center is committed to helping
                            students navigate the complex issues of college
                            life. Whether it is stress from exams, managing
                            mental health, or finding the right career path, we
                            are here to help. Our experienced staff and peer
                            mentors offer personalized support to help students
                    ...
                    <CardContent>
                      <ol className="relative border-l border-gray-200 dark:border-gray-700">
                        ...
                        <li className="ml-4">
                          ...
                          <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                            Support request was assigned to a specialist for
                            further assistance.
                          </p>
                        </li>
                      </ol>
